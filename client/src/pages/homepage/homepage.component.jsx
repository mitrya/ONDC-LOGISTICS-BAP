			...
			<div className="content">
				<Container>
					...
					<div className="image-homepage">
						<img src="https://th.bing.com/th/id/OIP.447YziGb5D5LTmhWH7AceAHaEU?pid=ImgDet&rs=1" className="img-fluid" alt="Mission image" />
					</div>
					...
					<div className="image-homepage justify-content-center">
						<img src="https://th.bing.com/th/id/OIP.e1me_6IwMOcMZVH_MUk_9gHaFb?pid=ImgDet&rs=1" className="img-fluid" alt="Team image" />
					</div>
					...
					<div className="image-homepage">
						<img src="https://my1wifi.b-cdn.net/wp-content/uploads/2021/04/What-to-know-about-Internet-Speed-while-Working-from-Home-768x528.jpg" className="img-fluid" alt="Platform image" />
					</div>
