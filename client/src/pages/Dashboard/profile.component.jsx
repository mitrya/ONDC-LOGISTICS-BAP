...
const Profile = () => {
		...
		</div>
	{
		...
		<div className="row">
		<Button id={upAdd ? 'hidden Update-address' : 'Update-address'} className='sub-btn'  onClick={handleClick} >
	...
	<div className='cards-in-row' style={{alignSelf:'center'}}>
		...
		<div className='card-account' style={{backgroundColor:'#dbc3e4'}}onClick={() => navigate('/')}>
		...
		<div className='card-account'style={{backgroundColor:'#d1e4c3'}}onClick={() => navigate('/orders')}>
